...
### 2.4. 별자리 궁합 보기 (Cosmic Compatibility) - 신규
별자리 상세 모달 내에서 다른 별자리와의 궁합을 즉시 확인할 수 있는 기능입니다.

*   **위치:** 별자리 모달 하단.
*   **기능:** 상대방 별자리를 드롭다운으로 선택하면 점수와 코멘트가 나타남.
*   **로직:** 4원소(불, 물, 흙, 공기) 기반의 상성 알고리즘 + 약간의 랜덤 변수 적용.
