...
const translations = {
    en: {
        ...
        homeCtaWeeklyDesc: "Use Gemini season, the post-full-moon afterflow, and the June 8 last-quarter approach to scan next week by sign.",
        homeCtaWeeklyBadge: "June 1 - June 7",
        ...
        homeCtaMoneyBadge: "June 1 - June 7",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-06-01-06-07-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "June 1 - June 7",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use Gemini season, the post-full-moon afterflow, and the June 8 last-quarter approach to scan next steps by sign.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "June 1 - June 7",
        ...
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-06-01-06-07-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (June 1–June 7)",
            meta: "June 1–June 7, 2026 | Cosmic Insight",
            p1: "A first-week-of-June reset shaped by Gemini season, the May 31 full-moon afterflow, and the approach to the June 8 last quarter moon.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (June 1–June 7)",
            meta: "June 1–June 7, 2026 | Cosmic Insight",
            p1: "An early-June money reset for fixed costs, post-full-moon settlement, and one repeat expense to reduce.",
            linkText: "📖 Read Weekly Money Outlook (Click Here) →",
            linkUrl: "blog_posts/weekly-money-zodiac-06-01-06-07-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaWeeklyDesc: "6월 첫 주와 하현달 직전 포인트를 별자리별로 빠르게 확인해보세요.",
        homeCtaWeeklyBadge: "06.01 - 06.07",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords.html",
        homeCtaMoney: "금전운 보기 →",
        homeCtaMoneyTitle: "주간 금전운",
        homeCtaMoneyDesc: "6월 첫 주 자동결제와 지출 축소 흐름을 반영한 다음 주 금전운입니다.",
        homeCtaMoneyBadge: "06.01 - 06.07",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-06-01-06-07.html",
        fortunes: {
        ...
        homeWisdom1Badge: "06.01 - 06.07",
        homeWisdom1Title: "이번 주 운세 키워드",
        homeWisdom1Desc: "월말 정리와 보름달 포인트를 별자리별 키워드로 빠르게 확인해보세요.",
        homeWisdom1Cta: "바로 보기 →",
        homeWisdom1Url: "blog_posts/weekly-keywords.html",
        homeWisdom2Badge: "06.01 - 06.07",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "6월 첫 주 자동결제와 지출 축소 흐름을 반영해 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-06-01-06-07.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (6월 1일–7일)",
            meta: "2026년 6월 1일–7일 | 우주의 통찰",
            p1: "6월 첫 주, 쌍둥이자리 시즌, 보름달 직후와 하현달 직전 흐름을 바탕으로 12별자리 포인트를 다시 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (6월 1일–7일)",
            meta: "2026년 6월 1일–7일 | 우주의 통찰",
            p1: "6월 첫 주와 보름달 이후, 하현달 직전 흐름을 반영해 다음 주 예산·정산·결제 리듬을 다시 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-06-01-06-07.html"
        },
        article18: {
