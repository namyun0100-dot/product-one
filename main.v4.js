...
const translations = {
    en: {
        ...
        homeCtaText: "Checked today's score? Keep going with next week's pre-new-moon cleanup and reset.",
        homeCtaWeekly: "Open Weekly Horoscope →",
        homeCtaWeeklyTitle: "Weekly Horoscope Keywords",
        homeCtaWeeklyDesc: "Use the waning moon after June 29 and the July 14 new moon reset to scan next week by sign.",
        homeCtaWeeklyBadge: "July 6 - July 12",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords-en.html",
        homeCtaMoney: "Open Money Outlook →",
        homeCtaMoneyTitle: "Weekly Money Outlook",
        homeCtaMoneyDesc: "Review autopay, cash flow, reimbursements, and emotional spending before the new moon.",
        homeCtaMoneyBadge: "July 6 - July 12",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-07-06-07-12-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "July 6 - July 12",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use the pre-new-moon week to close loops, clear space, and simplify.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "July 6 - July 12",
        homeWisdom2Title: "Weekly Money Outlook",
        homeWisdom2Desc: "Review autopay, cash flow, reimbursements, and emotional spending before the new moon.",
        homeWisdom2Cta: "Open Money Outlook →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-07-06-07-12-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (July 6–July 12)",
            meta: "July 6–July 12, 2026 | Cosmic Insight",
            p1: "A waning-moon cleanup week before the July 14 new moon, with each sign focused on closure and reset.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (July 6–July 12)",
            meta: "July 6–July 12, 2026 | Cosmic Insight",
            p1: "A pre-new-moon money check for autopay, cash flow, reimbursements, and emotional spending.",
            linkText: "📖 Read Weekly Money Outlook (Click Here) →",
            linkUrl: "blog_posts/weekly-money-zodiac-07-06-07-12-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaText: "오늘 점수를 확인했다면, 다음 주 신월 전 정리 흐름도 바로 확인해보세요.",
        homeCtaWeekly: "이번 주 운세 보기 →",
        homeCtaWeeklyTitle: "이번 주 운세 키워드",
        homeCtaWeeklyDesc: "6월 29일 보름달 이후 기우는 달과 7월 14일 신월 전 정리 포인트를 확인해보세요.",
        homeCtaWeeklyBadge: "07.06 - 07.12",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords.html",
        homeCtaMoney: "금전운 보기 →",
        homeCtaMoneyTitle: "주간 금전운",
        homeCtaMoneyDesc: "신월 전 자동결제, 현금 흐름, 감정 소비를 점검하는 다음 주 금전운입니다.",
        homeCtaMoneyBadge: "07.06 - 07.12",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-07-06-07-12.html",
        fortunes: {
        ...
        homeWisdom1Badge: "07.06 - 07.12",
        homeWisdom1Title: "이번 주 운세 키워드",
        homeWisdom1Desc: "신월 전 기우는 달의 정리 포인트를 별자리별 키워드로 확인해보세요.",
        homeWisdom1Cta: "바로 보기 →",
        homeWisdom1Url: "blog_posts/weekly-keywords.html",
        homeWisdom2Badge: "07.06 - 07.12",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "자동결제, 정산, 감정 소비 점검을 중심으로 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-07-06-07-12.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (7월 6일–7월 12일)",
            meta: "2026년 7월 6일–7월 12일 | 우주의 통찰",
            p1: "6월 29일 보름달 이후 기우는 달과 7월 14일 신월 직전 흐름을 바탕으로 12별자리 포인트를 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (7월 6일–7월 12일)",
            meta: "2026년 7월 6일–7월 12일 | 우주의 통찰",
            p1: "신월 전 자동결제, 현금 흐름, 감정 소비를 중심으로 다음 주 지출 기준을 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-07-06-07-12.html"
        },
        article18: {
