...
const translations = {
    en: {
        ...
        homeCtaText: "Checked today's score? Keep going with next week's month-end and full-moon reads.",
        homeCtaWeekly: "Open Weekly Horoscope →",
        homeCtaWeeklyTitle: "Weekly Horoscope Keywords",
        homeCtaWeeklyDesc: "Use Taurus-season steadiness and the May 1 full moon to scan next week by sign.",
        homeCtaWeeklyBadge: "Apr 27 - May 3",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords-en.html",
        homeCtaMoney: "Open Money Outlook →",
        homeCtaMoneyTitle: "Weekly Money Outlook",
        homeCtaMoneyDesc: "Review month-end spending, saving, and payment timing for next week.",
        homeCtaMoneyBadge: "Apr 27 - May 3",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-04-27-05-03-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "Apr 27 - May 3",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use the full-moon week to scan next steps by zodiac sign.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "Apr 27 - May 3",
        homeWisdom2Title: "Weekly Money Outlook",
        homeWisdom2Desc: "Review month-end spending, saving, and payment timing for next week.",
        homeWisdom2Cta: "Open Money Outlook →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-04-27-05-03-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (Apr 27–May 3)",
            meta: "Apr 27–May 3, 2026 | Cosmic Insight",
            p1: "A full-moon week with Taurus-season steadiness, mapped across all 12 signs.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (Apr 27–May 3)",
            meta: "Apr 27–May 3, 2026 | Cosmic Insight",
            p1: "A month-end money check for the coming week with sign-by-sign cues and a practical checklist.",
            linkText: "📖 Read Weekly Money Outlook (Click Here) →",
            linkUrl: "blog_posts/weekly-money-zodiac-04-27-05-03-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaText: "오늘 점수를 확인했다면, 다음 주 월말과 보름달 흐름도 바로 이어서 확인해보세요.",
        homeCtaWeekly: "이번 주 운세 보기 →",
        homeCtaWeeklyTitle: "이번 주 운세 키워드",
        homeCtaWeeklyDesc: "황소자리 시즌의 안정감과 5월 1일 보름달 흐름을 별자리별로 빠르게 확인해보세요.",
        homeCtaWeeklyBadge: "04.27 - 05.03",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords.html",
        homeCtaMoney: "금전운 보기 →",
        homeCtaMoneyTitle: "주간 금전운",
        homeCtaMoneyDesc: "월말 정산과 5월 초 결제 타이밍을 다음 주 기준으로 정리한 금전운입니다.",
        homeCtaMoneyBadge: "04.27 - 05.03",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-04-27-05-03.html",
        fortunes: {
        ...
        homeWisdom1Badge: "04.27 - 05.03",
        homeWisdom1Title: "이번 주 운세 키워드",
        homeWisdom1Desc: "보름달이 걸린 다음 주 흐름을 별자리별 키워드로 빠르게 확인해보세요.",
        homeWisdom1Cta: "바로 보기 →",
        homeWisdom1Url: "blog_posts/weekly-keywords.html",
        homeWisdom2Badge: "04.27 - 05.03",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "월말 정산과 5월 초 결제 타이밍을 다음 주 기준으로 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-04-27-05-03.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (4월 27일–5월 3일)",
            meta: "2026년 4월 27일–5월 3일 | 우주의 통찰",
            p1: "황소자리 시즌의 유지력과 5월 1일 보름달 정점감을 바탕으로 12별자리 포인트를 다시 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (4월 27일–5월 3일)",
            meta: "2026년 4월 27일–5월 3일 | 우주의 통찰",
            p1: "월말 정산과 보름달 흐름을 반영해 다음 주 소비·저축·결제 타이밍을 다시 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-04-27-05-03.html"
        },
        article18: {
