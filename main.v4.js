...
const translations = {
    en: {
        ...
        homeCtaText: "Checked today's score? Keep going with next week's post-solstice growth and pre-full-moon check-in.",
        homeCtaWeekly: "Open Weekly Horoscope →",
        homeCtaWeeklyTitle: "Weekly Horoscope Keywords",
        homeCtaWeeklyDesc: "Use the June 21 first quarter moon and solstice, then the June 29 full-moon buildup, to scan next week by sign.",
        homeCtaWeeklyBadge: "June 22 - June 28",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords-en.html",
        homeCtaMoney: "Open Money Outlook →",
        homeCtaMoneyTitle: "Weekly Money Outlook",
        homeCtaMoneyDesc: "Sort summer costs, slow non-urgent payments, and review repeat expenses before the full moon.",
        homeCtaMoneyBadge: "June 22 - June 28",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-06-22-06-28-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "June 22 - June 28",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use the post-solstice waxing moon and the June 29 full-moon buildup to scan next steps by sign.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "June 22 - June 28",
        homeWisdom2Title: "Weekly Money Outlook",
        homeWisdom2Desc: "Sort summer costs, slow non-urgent payments, and review repeat expenses before the full moon.",
        homeWisdom2Cta: "Open Money Outlook →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-06-22-06-28-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (June 22–June 28)",
            meta: "June 22–June 28, 2026 | Cosmic Insight",
            p1: "A post-solstice waxing-moon week leading into the June 29 full moon.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (June 22–June 28)",
            meta: "June 22–June 28, 2026 | Cosmic Insight",
            p1: "A pre-full-moon money check for summer costs, repeat payments, and slower spending decisions.",
            linkText: "📖 Read Weekly Money Outlook (Click Here) →",
            linkUrl: "blog_posts/weekly-money-zodiac-06-22-06-28-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaText: "오늘 점수를 확인했다면, 다음 주 하지 직후와 보름달 전 차오르는 흐름도 바로 확인해보세요.",
        homeCtaWeekly: "이번 주 운세 보기 →",
        homeCtaWeeklyTitle: "이번 주 운세 키워드",
        homeCtaWeeklyDesc: "6월 21일 상현달·하지 직후부터 6월 29일 보름달 전까지의 포인트를 확인해보세요.",
        homeCtaWeeklyBadge: "06.22 - 06.28",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords.html",
        homeCtaMoney: "금전운 보기 →",
        homeCtaMoneyTitle: "주간 금전운",
        homeCtaMoneyDesc: "하지 직후 여름 비용 선별과 보름달 전 반복 비용 점검을 반영한 다음 주 금전운입니다.",
        homeCtaMoneyBadge: "06.22 - 06.28",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-06-22-06-28.html",
        fortunes: {
        ...
        homeWisdom1Badge: "06.22 - 06.28",
        homeWisdom1Title: "이번 주 운세 키워드",
        homeWisdom1Desc: "하지 직후 차오르는 달과 보름달 전 조율 포인트를 별자리별 키워드로 확인해보세요.",
        homeWisdom1Cta: "바로 보기 →",
        homeWisdom1Url: "blog_posts/weekly-keywords.html",
        homeWisdom2Badge: "06.22 - 06.28",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "여름 비용 선별과 반복 비용 점검을 중심으로 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-06-22-06-28.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (6월 22일–28일)",
            meta: "2026년 6월 22일–28일 | 우주의 통찰",
            p1: "6월 21일 상현달·하지 직후부터 6월 29일 보름달 전까지의 흐름을 바탕으로 12별자리 포인트를 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (6월 22일–28일)",
            meta: "2026년 6월 22일–28일 | 우주의 통찰",
            p1: "하지 직후 여름 비용 선별과 보름달 전 반복 비용 점검을 중심으로 다음 주 지출 기준을 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-06-22-06-28.html"
        },
        article18: {
