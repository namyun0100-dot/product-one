...
const translations = {
    en: {
        ...
        homeCtaText: "Checked today's score? Keep going with next week's post-new-moon standards and small actions.",
        homeCtaWeekly: "Open Weekly Horoscope →",
        homeCtaWeeklyTitle: "Weekly Horoscope Keywords",
        homeCtaWeeklyDesc: "Use the July 14 new moon and waxing moon to scan next week by sign.",
        homeCtaWeeklyBadge: "July 13 - July 19",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords-en.html",
        homeCtaMoney: "Open Money Outlook →",
        homeCtaMoneyTitle: "Weekly Money Outlook",
        homeCtaMoneyDesc: "Review new budget standards, scheduled payments, and shared costs after the new moon.",
        homeCtaMoneyBadge: "July 13 - July 19",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-07-13-07-19-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "July 13 - July 19",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use the post-new-moon week to set one small standard and make it repeatable.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "July 13 - July 19",
        homeWisdom2Title: "Weekly Money Outlook",
        homeWisdom2Desc: "Review new budget standards, scheduled payments, and shared costs after the new moon.",
        homeWisdom2Cta: "Open Money Outlook →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-07-13-07-19-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (July 13–July 19)",
            meta: "July 13–July 19, 2026 | Cosmic Insight",
            p1: "A post-new-moon week for turning one fresh intention into a small repeatable action.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (July 13–July 19)",
            meta: "July 13–July 19, 2026 | Cosmic Insight",
            p1: "A post-new-moon money check for budget standards, scheduled payments, and shared costs.",
            linkText: "📖 Read Weekly Money Outlook (Click Here) →",
            linkUrl: "blog_posts/weekly-money-zodiac-07-13-07-19-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaText: "오늘 점수를 확인했다면, 다음 주 신월 직후 새 기준과 작은 실행 흐름도 확인해보세요.",
        homeCtaWeekly: "이번 주 운세 보기 →",
        homeCtaWeeklyTitle: "이번 주 운세 키워드",
        homeCtaWeeklyDesc: "7월 14일 신월 이후 차오르는 달의 작은 실행 포인트를 확인해보세요.",
        homeCtaWeeklyBadge: "07.13 - 07.19",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords.html",
        homeCtaMoney: "금전운 보기 →",
        homeCtaMoneyTitle: "주간 금전운",
        homeCtaMoneyDesc: "신월 이후 새 예산 기준, 예약 결제, 공동 비용을 점검하는 다음 주 금전운입니다.",
        homeCtaMoneyBadge: "07.13 - 07.19",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-07-13-07-19.html",
        fortunes: {
        ...
        homeWisdom1Badge: "07.13 - 07.19",
        homeWisdom1Title: "이번 주 운세 키워드",
        homeWisdom1Desc: "신월 이후 작은 실행 포인트를 별자리별 키워드로 확인해보세요.",
        homeWisdom1Cta: "바로 보기 →",
        homeWisdom1Url: "blog_posts/weekly-keywords.html",
        homeWisdom2Badge: "07.13 - 07.19",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "새 예산 기준, 예약 결제, 공동 비용 점검을 중심으로 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-07-13-07-19.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (7월 13일–7월 19일)",
            meta: "2026년 7월 13일–7월 19일 | 우주의 통찰",
            p1: "7월 14일 신월 이후 차오르는 달과 7월 21일 상현달 직전 흐름을 바탕으로 12별자리 포인트를 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (7월 13일–7월 19일)",
            meta: "2026년 7월 13일–7월 19일 | 우주의 통찰",
            p1: "신월 이후 새 예산 기준, 예약 결제, 공동 비용을 중심으로 다음 주 지출 기준을 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-07-13-07-19.html"
        },
        article18: {
