...
const translations = {
    en: {
        ...
        homeCtaText: "Checked today's score? Keep going with next week's featured reads.",
        homeCtaWeekly: "Open Weekly Horoscope →",
        homeCtaWeeklyTitle: "Weekly Horoscope Keywords",
        homeCtaWeeklyDesc: "Use the post-new-moon reset to scan next week by zodiac sign.",
        homeCtaWeeklyBadge: "Apr 20 - Apr 26",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords-en.html",
        homeCtaMoney: "Open Money Outlook →",
        homeCtaMoneyTitle: "Weekly Money Outlook",
        homeCtaMoneyDesc: "Review spending, saving, and payment timing for next week.",
        homeCtaMoneyBadge: "Apr 20 - Apr 26",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-04-20-04-26-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "Apr 20 - Apr 26",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use the post-new-moon reset to scan next week by zodiac sign.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "Apr 20 - Apr 26",
        homeWisdom2Title: "Weekly Money Outlook",
        homeWisdom2Desc: "Review spending, saving, and payment timing for next week.",
        homeWisdom2Cta: "Open Money Outlook →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-04-20-04-26-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (Apr 20–Apr 26)",
            meta: "Apr 20–Apr 26, 2026 | Cosmic Insight",
            p1: "A reset after the new moon and a steadier Taurus-season pace, mapped across all 12 signs.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (Apr 20–Apr 26)",
            meta: "Apr 20–Apr 26, 2026 | Cosmic Insight",
            p1: "A steadier money reset for the coming week with sign-by-sign cues and a practical checklist.",
            linkText: "📖 Read Weekly Money Outlook (Click Here) →",
            linkUrl: "blog_posts/weekly-money-zodiac-04-20-04-26-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaText: "오늘 점수를 확인했다면, 다음 주 흐름도 바로 이어서 확인해보세요.",
        homeCtaWeekly: "이번 주 운세 보기 →",
        homeCtaWeeklyTitle: "이번 주 운세 키워드",
        homeCtaWeeklyDesc: "새달 직후 리셋 감각과 황소자리 시즌 흐름을 별자리별로 빠르게 확인해보세요.",
        homeCtaWeeklyBadge: "04.20 - 04.26",
        ...
        homeCtaMoneyBadge: "04.20 - 04.26",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-04-20-04-26.html",
        fortunes: {
        ...
        homeWisdom2Badge: "04.20 - 04.26",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "소비, 저축, 결제 타이밍을 다음 주 기준으로 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-04-20-04-26.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (4월 20일–26일)",
            meta: "2026년 4월 20일–26일 | 우주의 통찰",
            p1: "새달 직후 리셋 감각과 황소자리 시즌의 안정 흐름을 바탕으로 12별자리 포인트를 다시 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (4월 20일–26일)",
            meta: "2026년 4월 20일–26일 | 우주의 통찰",
            p1: "새달 직후 소비 리셋과 황소자리 시즌의 안정 흐름을 반영해 다음 주 금전운을 다시 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-04-20-04-26.html"
        },
        article18: {
