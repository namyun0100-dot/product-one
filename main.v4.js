...
const translations = {
    en: {
        ...
        homeCtaText: "Checked today's score? Keep going with next week's post-full-moon reset and last-quarter rhythm.",
        homeCtaWeekly: "Open Weekly Horoscope →",
        homeCtaWeeklyTitle: "Weekly Horoscope Keywords",
        homeCtaWeeklyDesc: "Use the post-full-moon cleanup and the May 9 last quarter to scan next week by sign.",
        homeCtaWeeklyBadge: "May 4 - May 10",
        ...
        homeCtaMoneyBadge: "May 4 - May 10",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-05-04-05-10-en.html",
        fortunes: {
        ...
        homeWisdom1Badge: "May 4 - May 10",
        homeWisdom1Title: "Weekly Horoscope Keywords",
        homeWisdom1Desc: "Use the post-full-moon cleanup and last-quarter rhythm to scan next steps by sign.",
        homeWisdom1Cta: "Open Weekly Horoscope →",
        homeWisdom1Url: "blog_posts/weekly-keywords-en.html",
        homeWisdom2Badge: "May 4 - May 10",
        ...
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-05-04-05-10-en.html",
        ...
        article11: {
            title: "🧭 Zodiac Weekly Fortune Points (May 4–May 10)",
            meta: "May 4–May 10, 2026 | Cosmic Insight",
            p1: "A post-full-moon reset week with the May 9 last quarter and Taurus-season steadiness, mapped across all 12 signs.",
            linkText: "📖 Read Weekly Fortune Guide (Click Here) →",
            linkUrl: "blog_posts/weekly-keywords-en.html"
        },
        article17: {
            title: "💸 Weekly Money Outlook (May 4–May 10)",
            meta: "May 4–May 10, 2026 | Cosmic Insight",
            ...
            linkUrl: "blog_posts/weekly-money-zodiac-05-04-05-10-en.html"
        },
        article18: {
    ...
    ko: {
        ...
        homeCtaText: "오늘 점수를 확인했다면, 다음 주 보름달 직후 정리 흐름과 하현달 리듬도 바로 이어서 확인해보세요.",
        homeCtaWeekly: "이번 주 운세 보기 →",
        homeCtaWeeklyTitle: "이번 주 운세 키워드",
        homeCtaWeeklyDesc: "보름달 직후 정리 흐름과 5월 9일 하현달 포인트를 별자리별로 빠르게 확인해보세요.",
        homeCtaWeeklyBadge: "05.04 - 05.10",
        homeCtaWeeklyUrl: "blog_posts/weekly-keywords.html",
        homeCtaMoney: "금전운 보기 →",
        homeCtaMoneyTitle: "주간 금전운",
        homeCtaMoneyDesc: "보름달 직후 감산 흐름과 5월 9일 하현달을 반영한 다음 주 금전운입니다.",
        homeCtaMoneyBadge: "05.04 - 05.10",
        homeCtaMoneyUrl: "blog_posts/weekly-money-zodiac-05-04-05-10.html",
        fortunes: {
        ...
        homeWisdom1Badge: "05.04 - 05.10",
        homeWisdom1Title: "이번 주 운세 키워드",
        homeWisdom1Desc: "보름달 직후 정리 흐름과 하현달 포인트를 별자리별 키워드로 빠르게 확인해보세요.",
        homeWisdom1Cta: "바로 보기 →",
        homeWisdom1Url: "blog_posts/weekly-keywords.html",
        homeWisdom2Badge: "05.04 - 05.10",
        homeWisdom2Title: "주간 금전운",
        homeWisdom2Desc: "보름달 직후 감산 흐름과 5월 9일 하현달을 반영해 다시 정리했습니다.",
        homeWisdom2Cta: "금전운 보기 →",
        homeWisdom2Url: "blog_posts/weekly-money-zodiac-05-04-05-10.html",
        readMore: "전체 글 보기 →",
        ...
        article11: {
            title: "🧭 별자리별 이번 주 운세 포인트 (5월 4일–10일)",
            meta: "2026년 5월 4일–10일 | 우주의 통찰",
            p1: "보름달 직후 정리 흐름과 5월 9일 하현달, 황소자리 시즌의 현실 감각을 바탕으로 12별자리 포인트를 다시 정리했습니다.",
            linkText: "📖 이번 주 운세 보기 (클릭) →",
            linkUrl: "blog_posts/weekly-keywords.html"
        },
        article17: {
            title: "💸 주간 금전운 요약 (5월 4일–10일)",
            meta: "2026년 5월 4일–10일 | 우주의 통찰",
            p1: "보름달 직후 감산 흐름과 5월 9일 하현달을 반영해 다음 주 소비·저축·고정비 리듬을 다시 정리했습니다.",
            linkText: "📖 주간 금전운 읽기 →",
            linkUrl: "blog_posts/weekly-money-zodiac-05-04-05-10.html"
        },
        article18: {
